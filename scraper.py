...
s=Service('/C:/Users/Madhuvrat Sharma/venv/Scripts/msedgedriver.exe')
browser=webdriver.Chrome(service=s)
browser.get(START_URL)
time.sleep(10)
planets_data=[]
headers=['name','light_years_from_earth','planet_mass','stellar_magnitude','discovery_date','hyperlink','planet_type','planet_radius','orbital_radius','orbital_period','eccentricty']
